      ...
      <div className="fixed bottom-8 right-8 z-[100] flex flex-col gap-3 pointer-events-none">
        <AnimatePresence mode="popLayout">
          {toasts.map((toast) => (
            ...
            >
              <div className="glass-card flex items-center gap-4 px-6 py-4 min-w-[300px] border border-white/10 shadow-2xl backdrop-blur-2xl">
                <div className={cn(
                ...
                <div className="flex-1">
                  <p className="text-[10px] font-black uppercase tracking-[0.2em] text-zinc-500 mb-0.5">System_Alert</p>
...
// Utility for internal usage in the provider
